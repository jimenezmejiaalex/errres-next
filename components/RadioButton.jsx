function RadioButton({ title, value, active, handleOnclick }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="w-48 bg-white hover:bg-gray-100 cursor-pointer rounded-lg shadow-md p-6 hover:cursor-pointer mb-8 hover:bg-green-lightest focus:outline-none focus:shadow-outline-green"
      tabIndex={0}
    >
      <div className="flex justify-center items-center mb-3">
        <h1 className="uppercase font-bold text-base tracking-wide text-blue-darker my-2 mr-2">
          {title}
        </h1>
        {active && (
          <div>
