...
function MobileModal({ setshow }) {
  return (
    <div
      ...
      className="h-screen w-full fixed top-0 left-0 flex justify-center items-center bg-white"
    >
      <div
        className="absolute top-10 right-10 text-eden cursor-pointer hover:text-leather"
      ...
      <ul className="h-48 text-center space-y-4">
        <li
          onClick={() => setshow(false)}
          className="cursor-pointer text-2xl text-eden hover:text-leather"
        >
          <Link href="/">
            <a>Inicio</a>
          </Link>
