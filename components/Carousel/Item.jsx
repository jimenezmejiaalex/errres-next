...
function Item({
  ...
  const boxStyle = {
    height: `${
      breakpointData.breakpoint === 'large'
        ? 344
        : breakpointData.breakpoint === 'desktop'
        ? 444
        : ''
    }px`
  }
  ...
  return (
    ...
    >
      ...
      <div className=" w-full lg:w-1/2 h-full flex items-end justify-end">
        {children}
      </div>
    </div>
  )
