            ...
            <div className="bg-white p-4">
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        ...
                        <input onChange={handleReferenceId} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="referencia" type="text" placeholder="ID Referencia" />
                    </div>
                </div>
                <div className="overflow-hidden relative w-64 mt-4 mb-4">
                    <button className="bg-eden hover:bg-blue-light text-white font-bold py-2 px-4 w-full inline-flex items-center">
