        ...
        <div className="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-left">
          ...
          <div className="p-5 w-1/2 sm:w-4/12 md:w-3/12">
            ...
            <Link href="/">
              <a>
                <img
                  src={`${process.env.NEXT_PUBLIC_SERVER_IMAGES}${general.logo.media_image}`}
                  alt="Inicio"
                />
              </a>
            </Link>
          ...
          <div className="p-5 w-1/2 sm:w-4/12 md:w-3/12">
            ...
            <a
              ...
              className="text-xs cursor-pointer text-gray-400 font-medium mb-6 flex items-center space-x-2"
            >
          ...
          <div className="p-5 w-1/2 sm:w-4/12 md:w-3/12">
            ...
            >
              <a className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-eden cursor-pointer hover:underline">
                  Tienda en Linea
                </span>
              </a>
            </Link>
