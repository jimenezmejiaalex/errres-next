            ...
            {username && (
                <div className="flex space-x-4">
                    ...
                    <div className="flex space-x-1 text-eden items-center">
                        ...
                        <svg onClick={handleLogout} className="hover:text-leather cursor-pointer" width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
