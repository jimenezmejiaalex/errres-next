    ...
    <main className="mx-8 md:mx-12 lg:mx-32 xl:mx-56 flex flex-col lg:flex-row lg:space-x-10">
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            { url: `${process.env.NEXT_PUBLIC_SERVER_IMAGES}${introImage}` }
          ],
          site_name: 'Errres'
        }}
      />
      ...
      <div className=" w-full lg:w-1/2 ">
        ...
        <div className="my-4 text-xl text-leather font-bold underline">{`₡ ${parseInt(
          price
        )}`}</div>
        <div
        ...
        {productType && productType.length > 0 && (
          <div className="py-4">
            <h3 className="text-xl text-eden font-semibold">
              Tipo de producto:
            </h3>
            <ul>
