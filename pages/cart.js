        ...
        <div className="flex flex-col lg:flex-row shadow-md my-10">
          <div className="w-full lg:w-3/4 bg-white px-10 py-10">
            ...
            <div className="flex mt-10 mb-5">
              ...
              <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/3 text-center">
                Cantidad
              </h3>
              <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/3 text-center">
                Total
          ...
          <div id="summary" className=" w-full lg:w-1/4 px-8 py-10">
            ...
            <div className="flex justify-between mt-10 mb-5">
              ...
              <span className="font-semibold text-sm">{`₡ ${parseInt(
                total
              )}`}</span>
            </div>
            <div>
              ...
              >
                <option value={envioDentroGam}>{`Dentro del GAM - ₡ ${parseInt(
                  envioDentroGam
                )}`}</option>
                <option value={envioFueraGam}>{`Fuera del GAM - ₡ ${parseInt(
                  envioFueraGam
                )}`}</option>
              </select>
            </div>
            <div className="border-t mt-8">
              ...
              <button
                ...
                className="bg-eden font-semibold hover:bg-eden-400 py-3 text-sm text-white uppercase w-full"
              >
                Comprar
              </button>
            </div>
